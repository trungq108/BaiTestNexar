...
public class Movement : MonoBehaviour
{
    ...
    private Vector3 CalculateBezierPoint(float t, Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4)
    {
        float u = 1 - t;
        ...
        Vector3 p = uuu * p1 + 3 * uu * t * p2 + 3 * u * tt * p3 + ttt * p4; // (1-t)^3 * P0 + 3 * (1-t)^2 * t * P1 + 3 * (1-t) * t^2 * P2 + t^3 * P3
